        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="Editar">
                    <i class="fa fa-btn fa-indent"></i>Editar Tipo
                </h4>
            </div>
            ...
            <div class="modal-body">
                ...
                {!! Form::open(['route' => ['admin.tipo.update', 'IDTIPO'], 'method' => 'PUT', 'id' => 'form-update', 'class' => 'form-horizontal']) !!}

                @include('admin.tipo.partial.form')
