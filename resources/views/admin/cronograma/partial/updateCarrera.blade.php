<div class="modal fade" id="updateCarrera" tabindex="-1" role="dialog" aria-labelledby="Editar">
        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="Editar">
                    <i class="fa fa-btn fa-calendar"></i>Editar Carrera de Cronograma
                </h4>
            </div>
            ...
            <div class="modal-body">
                ...
                {!! Form::open(['route' => ['admin.cronograma_carrera.updateCarrera', 'IDLANZAMIENTOCARRERA'], 'method' => 'PUT', 'id' => 'form-updateCarrera', 'class' => 'form-horizontal']) !!}
...
<script>
    // Reset Form
    $('.modal#updateCarrera').on('show.bs.modal', function(e){
        resetForm($(this));
    });
    $('.modal#updateCarrera').on('hidden.bs.modal', function(e){
        resetForm($(this));
    });
    // Editar
    var formUpdate = $('#form-updateCarrera');
