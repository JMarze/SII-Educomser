        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="Agregar">
                    <i class="fa fa-btn fa-graduation-cap"></i>Agregar Profesión
                </h4>
            </div>

            <div class="modal-body">
                {!! Form::open(['route' => 'admin.profesion.store', 'method' => 'POST', 'id' => 'form-create', 'class' => 'form-horizontal']) !!}
...
<script>
    ...
    $(document).on('click', '#btn-agregar', function(){
        ...
        $.ajax({
            ...
            window.location.href = "/admin/profesion";
