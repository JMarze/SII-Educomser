        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="Eliminar">
                    <i class="fa fa-btn fa-graduation-cap"></i>Eliminar Profesión
                </h4>
            </div>
            ...
            <div class="modal-body">
                ...
                {!! Form::open(['route' => ['admin.profesion.destroy', 'IDPROFESION'], 'method' => 'DELETE', 'id' => 'form-destroy', 'class' => 'form-horizontal']) !!}
