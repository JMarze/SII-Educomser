    ...
    <div class="row">
        ...
        <div class="panel panel-default">
            <nav class="navbar navbar-default">
               <div class="container">
                   <div class="navbar-header">
                       ...
                       <a href="{{ route('admin.ayuda.carreras') }}" class="navbar-brand">
                   ...
                   <div class="collapse navbar-collapse" id="menu-panel">
                       ...
                       {!! Form::open(['route' => 'admin.ayuda.carreras', 'method' => 'GET', 'class' => 'navbar-form navbar-right', 'role' => 'search']) !!}
            ...
            <div class="content-ajax">
                @include('admin.ayuda.partial.table_carreras')
            </div>
