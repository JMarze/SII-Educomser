    ...
    <div class="row">
        ...
        <div class="panel panel-default">
            <nav class="navbar navbar-default">
               <div class="container">
                   <div class="navbar-header">
                       ...
                       <a href="{{ route('admin.ayuda.docentes') }}" class="navbar-brand">
                   ...
                   <div class="collapse navbar-collapse" id="menu-panel">
                       ...
                       {!! Form::open(['route' => 'admin.ayuda.docentes', 'method' => 'GET', 'class' => 'navbar-form navbar-right', 'role' => 'search']) !!}
                       <div class="input-group">
                           {!! Form::text('buscar_persona', null, ['placeholder' => 'Buscar persona...', 'class' => 'form-control']) !!}
            ...
            <div class="content-ajax">
                @include('admin.ayuda.partial.table_docentes')
            </div>
