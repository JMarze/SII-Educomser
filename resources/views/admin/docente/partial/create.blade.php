        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="Agregar">
                    <i class="fa fa-btn fa-user-plus"></i>Agregar Docente
                </h4>
            </div>
            ...
            <div class="modal-body">
                ...
                {!! Form::open(['route' => 'admin.docente.store', 'method' => 'POST', 'id' => 'form-create', 'class' => 'form-horizontal']) !!}

                @include('admin.docente.partial.form')
...
<script>
    ...
    $(document).on('click', '#btn-agregar', function(){
        ...
        $.ajax({
            ...
            window.location.href = "{{ route('admin.docente.index') }}";
