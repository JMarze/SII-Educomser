        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="Profesiones">
                    <i class="fa fa-btn fa-graduation-cap"></i>Editar Profesiones del Docente
                </h4>
            </div>
            ...
            <div class="modal-body">
                ...
                {!! Form::open(['route' => ['admin.docente.postattach', 'CODIGOPERSONA'], 'method' => 'PUT', 'id' => 'form-postattach', 'class' => 'form-horizontal']) !!}
