        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="Eliminar">
                    <i class="fa fa-btn fa-level-up"></i>Eliminar Dificultad
                </h4>
            </div>
            ...
            <div class="modal-body">
                ...
                {!! Form::open(['route' => ['admin.dificultad.destroy', 'IDDIFICULTAD'], 'method' => 'DELETE', 'id' => 'form-destroy', 'class' => 'form-horizontal']) !!}
