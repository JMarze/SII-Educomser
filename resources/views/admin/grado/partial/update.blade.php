        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="Editar">
                    <i class="fa fa-btn fa-graduation-cap"></i>Editar Grado
                </h4>
            </div>
            ...
            <div class="modal-body">
                ...
                {!! Form::open(['route' => ['admin.grado.update', 'IDGRADO'], 'method' => 'PUT', 'id' => 'form-update', 'class' => 'form-horizontal']) !!}

                @include('admin.grado.partial.form')
