    ...
    <div class="row">
        ...
        <div class="panel panel-default">
            <nav class="navbar navbar-default">
               <div class="container">
                   <div class="navbar-header">
                       ...
                       <a href="{{ route('admin.alumno.index') }}" class="navbar-brand">
                           <i class="fa fa-btn fa-user"></i>Alumnos
                       </a>
                   </div>
                   ...
                   <div class="collapse navbar-collapse" id="menu-panel">
                       <ul class="nav navbar-nav">
                           ...
                           <li>
                               <a href="{{ route('admin.alumno.index') }}">
                                   <i class="fa fa-btn fa-th"></i>Ver Todos
                               </a>
                           </li>
                       </ul>

                       {!! Form::open(['route' => 'admin.alumno.index', 'method' => 'GET', 'class' => 'navbar-form navbar-right', 'role' => 'search']) !!}
                       <div class="input-group">
                           {!! Form::text('buscar_persona', null, ['placeholder' => 'Buscar alumno...', 'class' => 'form-control']) !!}
            ...
            <div class="content-ajax">
                @include('admin.alumno.partial.table')
            </div>
...
@include('admin.alumno.partial.create')
@include('admin.alumno.partial.update')
@include('admin.alumno.partial.destroy')
@include('admin.alumno.partial.attach')
@endsection
...
<script>
    ...
    $(document).on('click', 'button[data-target="#create"]', function(e){
        var urlArea = '{{ route("admin.alumno.listar") }}';
        $.ajax({
            url: urlArea,
